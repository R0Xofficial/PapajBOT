...
# --- KONFIGURACJA ---
TELEGRAM_TOKEN = os.getenv("TELEGRAM_TOKEN", "TUTAJ_WSTAW_SWOJ_TOKEN")
...
def main() -> None:
    if "TUTAJ_WSTAW_SWOJ_TOKEN" in TELEGRAM_TOKEN:
        logger.error("Nie podano tokena bota! Uzupełnij zmienną TELEGRAM_TOKEN.")
        return
